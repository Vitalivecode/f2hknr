...
{
    // default connection
    public static $dbname = 'farmtohome_ci'; // Your database name
    public static $dbuser = 'farmtohome_pranay'; // Your database username
    public static $dbpass = 'Pranay@123$'; // // Your database password
