...
<tr>
	<td>
		...
		<p><a href="<?=base_url().'../Admin/forgot/password/'.urlencode($forgot_key).'/'.urlencode($id).'/'.url_title($data[0]->fullname,'-');?>" target="_blank">Click here to reset your password</a></p>
	</td>
</tr>
<tr>
	<td></td>
